...
import csnLogo from '../assets/images/csn-logo.png';
...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/10 backdrop-blur-lg text-white px-6 py-4 flex items-center justify-between fixed top-0 left-0 right-0 z-50 shadow-md">
      <div className="text-xl font-medium bg-gradient-to-r from-blue-500 via-blue-600 to-blue-800 bg-clip-text text-transparent drop-shadow-md">
<img src={csnLogo} alt="CSN logo" className="h-10" />
      </div>
        ...
        <div className="relative" ref={servicesRef}>
          ...
          {servicesOpen && (
            ...
            >
              ...
              <a href="/Payroll" className="px-4 py-2 hover:bg-gray-100 hover:text-black transition">
                Payroll       
            </a>
            </div>
          )}
